...
const PRECACHE=[
 path(''),path('index.html'),path('offline.html'),path('manifest.webmanifest'),
 path('assets/css/site.css'),path('assets/js/site.js'),
 path('icons/icon-192.png'),path('icons/icon-512.png'),path('icons/icon-maskable-512.png'),
 path('services/'),path('guides/'),path('experience/'),path('safety/dental-emergency/')
];
